<?php
    ...
    function arquetipoTexto($arquetipo)
    {
        $arrayTextos = [
            ...
            'amante' => 'Arquétipo que nos fala diretamente da nossa capacidade de entrega e comprometimento.
            ...
            ',
            'bobo' => 'Aquele que nos fala da espontaneidade, do despojamento e da criança interior. A confiança maior no fluxo da vida floresce neste arquétipo. 
            ...
            ',
            'caridoso' => 'Aquele que evoca uma das principais virtudes da alma, o espírito do serviço desinteressado.
            ...
            ',
            'criador' => 'rquétipo que nos fala diretamente da manifestação da nossa essência no mundo.
            ...
            ',
            'destruidor' => 'Representante da morte do eu e do fim dos ciclos.
            ...
            ',
            'explorador' => 'Aquele que evoca nossa relação com o mistério da vida.
            ...
            ',
            'governante' => 'Aquele que é senhor de si, nos fala da nossa relação com o poder pessoal, a visão do todo e capacidade de gerir os recursos disponíveis.
            ...
            ',
            'guerreiro' => 'Na jornada do herói se valer da imagem arquetípica significa olhar para a sua questão/problema através de uma lente, de um novo ângulo. 

            Neste caso temos aqui o arquétipo ancestral do Guerreiro, aquele que vai em direção ao alvo e cujo tema principal é a coragem. Mas coragem para que?
            ...
            ',
            'inocente' => 'O Inocente revela aquela qualidade de confiança presente na criança, que em sua vulnerabilidade se entrega aos cuidados e proteção dos pais.
            ...
            ',
            'mago' => 'Nos fala do verdadeiro poder pessoal e nossa capacidade de transformar. A alquimia que transforma chumbo em ouro.
            ...
            ',
            'órfão' => 'O Órfão nos chama para a necessidade de tocar nossa ferida primordial de abandono e fala do desejo inconsciente e negado de pertencer. 
            ...
            ',
            'sábio' => 'Aquele que traz o comprometimento com a busca da verdade, do conhecimento e da sabedoria.
        ...
        return [$arrayTextos[$arquetipo], $arrayVideos[$arquetipo]];
    }
    ...
    try{
        ...
        list($textoArquetipo, $videoLink) = arquetipoTexto($arquetipos[0]);
